...
def random_sleep():
    sleeping = round(random.randint(3,50) /3, 6)
...
# New Week https://10times.com/france?datefrom=2021-09-06&dateto=2021-09-12   stops because scroll needed
'''
